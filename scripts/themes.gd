...
const ORDER := ["sheen", "cotton", "meadow", "midnight", "crimson", "sunset", "neon", "matte", "glacier", "reef", "latte", "arcade"]
...
const THEMES := {
	...
	"cotton": {"name": "Cotton Candy", "style": "gloss", "bg": "#ffe9f4", "bg2": "#ffd8ec", "fg": "#5a3a4d", "accent": "#ef4d92", "panel": "#fff6fb",
		"palette": ["#f675ac", "#4199fb", "#29ad56", "#ecac13", "#7b2ff0", "#ffb38a"]},
	"meadow": {"name": "Meadow", "style": "gloss", "bg": "#e8f6ea", "bg2": "#d2ecd6", "fg": "#26402c", "accent": "#2e8b47", "panel": "#f6fdf7",
